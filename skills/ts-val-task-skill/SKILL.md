...
For the full review checklist and reporting format, see `~/.claude/docs/reference/claude/skills/task-subagent/skill-review-checklist.md`.
...
```bash
SKILL_SCRIPTS=~/.claude/skills/ts-val-task-skill/scripts
...
Read `~/.claude/docs/reference/claude/skills/task-subagent/skill-review-checklist.md` and work through each section (A–I):
...
Report results using the format defined in `~/.claude/docs/reference/claude/skills/task-subagent/skill-review-checklist.md` ("Reporting Format" section).
